...
static int mock_fips_rand_get_params(OSSL_PARAM params[])
{
    OSSL_PARAM *p;
...
static const OSSL_DISPATCH mock_fips_rand_functions[] = {
    { OSSL_FUNC_RAND_NEWCTX, (void (*)(void))mock_rand_newctx },
    { OSSL_FUNC_RAND_FREECTX, (void (*)(void))mock_rand_freectx },
    { OSSL_FUNC_RAND_INSTANTIATE, (void (*)(void))mock_rand_instantiate },
    { OSSL_FUNC_RAND_UNINSTANTIATE, (void (*)(void))mock_rand_uninstantiate },
    ...
    { OSSL_FUNC_RAND_ENABLE_LOCKING, (void (*)(void))mock_rand_enable_locking },
    { OSSL_FUNC_RAND_GET_CTX_PARAMS, (void(*)(void))mock_rand_get_ctx_params },
    { OSSL_FUNC_RAND_GET_PARAMS, (void(*)(void))mock_fips_rand_get_params },
    { 0, NULL }
};

static const OSSL_ALGORITHM mock_provider_rand[] = {
    { "MOCK-DRBG", "provider=mock", mock_rand_functions },
    { "MOCK-FIPS-DRBG", "provider=mock,fips=yes", mock_fips_rand_functions },
    { NULL, NULL, NULL }
};
...
static int test_libctx_primary_fips_drbg_ignores_seed(void)
{
     ...
     * provider. This isn't allowed and the context should handle this.
     */
...
static int test_libctx_primary_mock_drbg_uses_seed(void)
{
    OSSL_LIB_CTX *ctx = NULL;
    EVP_RAND_CTX *rctx;
    int ok = 0;
    ...
    if (!TEST_true(((MOCK_RAND *)rctx->algctx)->child))
        goto err;
...
static int test_libctx_primary_mock_fips_drbg_ignores_seed(void)
{
    OSSL_LIB_CTX *ctx = NULL;
    EVP_RAND_CTX *rctx;
    int ok = 0;
    ...
    if (!TEST_true(init_libctx(ctx)))
        goto err;
    if (!TEST_true(RAND_set_DRBG_type(ctx, "MOCK-FIPS-DRBG", NULL, NULL, NULL)))
        goto err;
...
static int test_libctx_drbgs_all_use_same_provider(void)
{
    ...
    if (!TEST_str_eq(OSSL_PROVIDER_get0_name(EVP_RAND_get0_provider(EVP_RAND_CTX_get0_rand(sctx))),
                     "fips"))
        goto err;
...
int setup_tests(void)
{
    ...
    ADD_TEST(test_libctx_primary_fips_drbg_ignores_seed);
    ADD_TEST(test_libctx_primary_mock_drbg_uses_seed);
    ADD_TEST(test_libctx_primary_mock_fips_drbg_ignores_seed);
